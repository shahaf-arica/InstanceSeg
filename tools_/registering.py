...
def register_all_datasets():
    ...
    register_coco_instances("coco_20k", {}, f"{coco_path}/annotations/instances_coco_20k.json", "")
    register_coco_instances("coco_20k_class_agnostic", {}, f"{coco_path}/annotations/instances_coco_20k_CAD.json", "")
